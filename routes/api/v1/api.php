...
Route::group(['namespace' => 'api\v1', 'prefix' => 'v1', 'middleware' => ['api_lang']], function () {
    ...
    Route::group(['prefix' => 'products'], function () {
        ...
        Route::get('get_products_materials', 'ProductController@get_products_materials');
        Route::get('get_products_colors', 'ProductController@get_products_colors');
        Route::post('get_product_color', 'ProductController@get_product_color');
    });
    ...
    Route::group(['prefix' => 'coupons'], function () {
        Route::get('/', 'AttributeController@get_coupons');
    });
