...
Route::group(['namespace' => 'Web','middleware'=>['maintenance_mode']], function () {
    ...
    Route::get('/handicraft', 'WebController@home2')->name('handicraft');
    Route::get('/decor', 'WebController@home3')->name('decor');
    Route::get('/artifacts', 'WebController@home4')->name('artifacts');
    
    Route::get('/coupons', 'WebController@coupons')->name('coupons');
