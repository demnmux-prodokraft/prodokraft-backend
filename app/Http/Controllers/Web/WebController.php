...
class WebController extends Controller
{
    ...
    public function home2()
    {
        ...
        $featured_products = Product::with(['reviews'])->active()
            ...
            ->get();
        //end
        // dd("database name ". DB::connection()->getDatabaseName());
    ...
    public function products(Request $request)
    {
        ...
        if ($request['data_from'] == 'material') {
            $query = $porduct_data->where('material', $request['material']);
        }
    ...
    {
        $c = Coupon::all();
        return view('web-views.coupons', compact('c'));
    }
