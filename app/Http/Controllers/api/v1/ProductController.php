...
class ProductController extends Controller
{
    ...
    public static function get_products_materials()
    {
        return Product::pluck('material')->unique()->values();
    }
    
    public static function get_products_colors()
    {
        return Color::pluck('code')->values();
    }
    
    public function get_product_color(Request $request)
    {
        $this->validate($request, [
            'code' => 'required|string', // Assuming the color code is sent as 'code'
        ]);

        $code = $request->input('code');
        $colorName = Color::where('code', $code)->value('name');

        return response()->json(['color_name' => $colorName]);
    }
}
