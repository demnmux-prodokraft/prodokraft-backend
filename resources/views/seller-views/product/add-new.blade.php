                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3 d-flex align-items-center gap-2">
                                        <label for="sizes" class="title-color mb-0">
                                            Sizes :
                                        </label>
                                        <!--<label class="switcher">-->
                                        <!--    <input type="checkbox" class="switcher_input" value="{{ old('sizes_active') }}"-->
                                        <!--        name="sizes_active">-->
                                        <!--    <span class="switcher_control"></span>-->
                                        <!--</label>-->
                                    </div>
                                    <select
                                        ...
                                        name="sizes[]" multiple="multiple" id="sizes-selector" >
                                 ...
                                 <div class="col-md-6">
                                    <div class="mb-3 d-flex align-items-center gap-2">
                                        <label for="material" class="title-color mb-0">
                                            Material :
                                        </label>
                                    </div>
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <div class="row align-items-end">
                                    ...
                                    <div class="col-md-4 mb-3" id="return-policy">
                                        <label class="title-color">{{ \App\CPU\translate('return_policy') }} </label>
                                        <span class="badge badge-soft-info"> 
                                            {{ \App\CPU\translate('in_days') }}
                                            </span>
                                        <input type="number" min="0" value="0" step="1"
                                            placeholder="{{ \App\CPU\translate('Enter number of days for return') }}" name="return_policy"
                                            class="form-control" required>
                                    </div>
                                     <div class="col-md-4 mb-3" id="exchange-policy">
                                        <label class="title-color">Exchange Policy</label>
                                        <span class="badge badge-soft-info"> 
                                            {{ \App\CPU\translate('in_days') }}
                                            </span>
                                        <input type="number" min="0" value="0" step="1"
                                            placeholder='Enter number of days for exchange' name="exchange_policy"
                                            class="form-control" required>
                                    </div>
                                    <div class="col-md-4 mb-3">
