...
<div class="__inline-9 rtl">
    ...
    <footer class="page-footer font-small mdb-color rtl" style="background-color:#a67c52;color:white;">
        <!-- Footer Links -->
                ...
                <div
                    ...
                    <div class="col-md-3 footer-web-logo" >
                        <a class="d-block" href="{{route('home')}}">
                            <img class="{{Session::get('direction') === "rtl" ? 'rightalign' : ''}}" id="footer-logo" src="{{asset("storage/app/public/company/")}}/{{ $web_config['footer_logo']->value }}"
                    ...
                    <div class="col-md-9" >
                        <div class="row">
                            ...
                            <!--</div>-->
                              ...
                              <div class="col-md-4 footer-padding-bottom" style="{{Session::get('direction') === "rtl" ? 'padding-right:20px;' : ''}}">
                                <h6 class="text-uppercase mb-4 font-weight-bold footer-heder">More</h6>
                                    ...
                                    <ul class="widget-list __pb-10px">
                                        ...
                                        <li class="widget-list-item"><a class="widget-list-link"
                                                                        href="{{route('shop.apply')}}">Sell On Prodokraft</a>
                                        </li>
                                    </ul>
                                    ...
                                    <div class="text-nowrap mb-4 position-relative">
                                        <form action="{{ route('subscription') }}" method="post">
                                            ...
                                            <input type="email" name="subscription_email" class="form-control subscribe-border"
                                                placeholder="{{\App\CPU\translate('Your Email Address')}}" required style="padding: 11px;text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};border-color:#a67c52">
                        ...
                        <div class="row mt-4 {{Session::get('direction') === "rtl" ? ' flex-row-reverse' : ''}}">
                            ...
                            <div class="col-md-5 ">
                                ...
                                <div class="pl-2">
                                    <span class="__text-14px" style="font-weight: bold;"><i class="fa fa-map-marker m-2" ></i> {{ \App\CPU\Helpers::get_business_settings('shop_address')}} </span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div style="background: {{$web_config['primary_color']}}10;">
            <div class="container">
                <div class="row end-footer footer-end last-footer-content-align">
                    <div class=" mt-3">
                        <p class="{{Session::get('direction') === "rtl" ? 'text-right ' : 'text-left'}} __text-16px" style="font-weight: bold;">{{ $web_config['copyright_text']->value }}</p>
                    </div>
                        ...
                        @if(isset($social_media))
                            @foreach ($social_media as $item)
                                <span class="social-media ">
                                        ...
                                        target="_blank" href="{{$item->link}}" style="color:#a67c52">
                    ...
                    <div class="d-flex __text-14px" style="gap : 50px;">
                        ...
                        <div>
                            <a class="widget-list-link" href="{{route('privacy-policy')}}" style="color:#a67c52; margin-right: 100px;">
