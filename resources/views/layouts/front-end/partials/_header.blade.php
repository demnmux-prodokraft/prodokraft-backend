...
<header class="box-shadow-sm rtl __inline-10">
    ...
    <div class="navbar-sticky bg-light mobile-head">
        <div class="navbar navbar-expand-md navbar-light d-flex justify-content-between" style="background-color:#f3e5d8">
            <!--<div class="d-flex justify-content-center">-->
                <div style="display:flex;    margin-left: 15px;">
                   
                
                <a class="navbar-brand  d-sm-block {{Session::get('direction') === "rtl" ? 'mr-3' : 'mr-3'}} flex-shrink-0 " href="{{route('home')}}">
                 ...
                 <p style="align-self:end;font-size:20px;color:{{$web_config['primary_color']}};font-weight: 700;" class="logo-text">{{\App\CPU\Helpers::get_business_settings('company_name')}} </p>
                 
                 </div>
                 <!--<div>-->
              
                <!-- Toolbar-->
                <div class="navbar-toolbar d-flex flex-shrink-0 align-items-center float-end" style="margin-top: 1%;">
                      <div class="input-group-overlay d-none d-md-block mx-4 ml-md-3"
                    ...
                    <div class="navbar-tool dropdown header-icon">
                   ...
                   @if(auth('customer')->check())
                        <div class="dropdown header-icon" style="margin-right:10px">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                ...
                                <a class="dropdown-item"
                                   ...
                                   <a class="dropdown-item"
                                   href="{{route('products',['data_from'=>'featured','page'=>1])}}"> Featured Offers </a>
                                   
                                   <a class="dropdown-item"
                                   href="{{route('helpTopic')}}"> FAQ's </a>
                                   
                                   <a class="dropdown-item"
                                   href="{{route('account-address')}}"> Address </a>
                                   
                                   <!--<a class="dropdown-item"-->
                                   <!--href="{{route('user-account')}}"> Payment Methods </a>-->
                                   
                                   <a class="dropdown-item"
                                   href="{{route('account-tickets')}}"> Support Ticket </a>
                    ...
                    @endif
                    <div id="cart_items " class="header-icon">
                        @include('layouts.front-end.partials.cart')
                    </div>
                     
                </div>
                <!-- Search-->
                <div class="input-group-overlay d-md-none my-3 d-flex">
                    <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarCollapse">
                    <span class="navbar-toggler-icon"></span>
                    </button>
                    <form action="{{route('products')}}" type="submit" class="search_form" style="width: 100% !important;">
       ...
       @if(request()->is('customer/auth/sign-up') || request()->is('customer/auth/login'))
