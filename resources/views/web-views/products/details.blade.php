...
@push('css_or_js')
    ...
    <script type='text/javascript' src='https://platform-api.sharethis.com/js/sharethis.js#property=6566d5ec3bcaed00121fca62&product=image-share-buttons' async='async'></script>
    ...
    <style>
        ...
        #st-1 .st-btn[data-network='facebook'], .st-btn[data-network='twitter'], .st-btn[data-network='pinterest'], .st-btn[data-network='email'] { 
                    ...
                    <div class="row">
                                    ...
                                    @if($product->images!=null)
                                        @foreach (json_decode($product->images) as $key => $photo)
                                            <div
                                                ...
                                                id="image{{$key}}">
                                                <img class="cz-image-zoom img-responsive w-100 __max-h-350px"
                        ...
                        <div class="col-lg-6 col-md-8 col-12 mt-md-0 mt-sm-3" style="direction: {{ Session::get('direction') }}">
                            <div class="details __h-100">
                                <span class="mb-2 __inline-24"><h1 class="produnct-name">{{$product->name}}</h1></span>
                                <span class="product-meta__reference ">
                                    <a class="product-meta__vendor link link--accented" >{{$product->seller->shop->name}}</a>
                                </span>
                                ...
                                <div class="mb-3" style="margin: 30px 14px 33px 0px;">
                                ...
                                <!-- Quantity + Add to cart -->
                                        ...
                                        <div class="product-quantity d-flex flex-wrap align-items-center __gap-15">
                                            ...
                                            <div id="chosen_price_div">
                                                <div class="d-flex justify-content-center align-items-center {{Session::get('direction') === "rtl" ? 'ml-2' : 'mr-2'}}">
                                                    <div class="product-description-label"><strong class="total-price" style="color: #4c4c4c;">{{\App\CPU\translate('total_price')}}</strong> : </div>
                                                    &nbsp; <strong id="chosen_price" class="total-price" ></strong>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="__btn-grp mt-2 mb-3 row">
                                        <button type="button" onclick="addWishlist('{{$product['id']}}')"
                                                class="btn __text-18px share-button">
                                            <span class='share-icon'> <i class="fa fa-heart-o "
                                            aria-hidden="true"></i></span>
                                           
                                            <span class="countWishlist-{{$product['id']}}">{{$countWishlist}}</span>
                                        </button>
                                        <button class="btn btn-secondary btn-lg element-center __iniline-26 btn-gap-{{Session::get('direction') === "rtl" ? 'left' : 'right'}}" onclick="buy_now()" type="button">
                                            <span class="string-limit">{{\App\CPU\translate('buy_now')}}</span>
                                        </button>
                                        <button
                                            class="btn btn--primary btn-lg element-center btn-gap-{{Session::get('direction') === "rtl" ? 'left' : 'right'}}"
                                ...
                                <div class="d-flex">
                                    <div>
                                         <button class="share-button" onclick="copyClipboard()" ><span class='share-icon' ><i class="fa fa-share-alt" style="margin:2px"></i></span></button>
                                         <div id="copy-message">Copied!</div>
                                    </div>
                                   
                                    <div style="margin-left:8px"><a href="#" class="share-button"><span class='share-icon'><i class="fa fa-whatsapp" style="margin:2px"></i></span></a></div>
                                </div>    
                            ...
                            <div class="px-3 py-3">
                                <img class="{{Session::get('direction') === "rtl" ? 'float-right ml-2' : 'mr-2'}} __img-20"
                                    src="{{asset("public/assets/front-end/png/money.png")}}"
                                        alt="">
                                <span>
                                    {{$product->return_policy!=0 ? $product->return_policy.' Days' : 'No'}}
                                </span>        
                                <span>{{ \App\CPU\translate(' Return Policy')}}</span>
                            </div>
                        </div>
                         <div  class="shipping-details-bottom-border">
                            <div class="px-3 py-3">
                                <img class="{{Session::get('direction') === "rtl" ? 'float-right ml-2' : 'mr-2'}} __img-20"
                                    src="{{asset("public/assets/front-end/png/money.png")}}"
                                        alt="">
                                <span>
                                    {{$product->exchange_policy!=0 ? $product->exchange_policy.' Days' : 'No'}}
                                </span>        
