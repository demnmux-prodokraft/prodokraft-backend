                ...
                <div class="cz-sidebar box-shadow-lg __inline-35" id="shop-sidebar">
                    ...
                    <div>
                     ...
                     <div>
                        <div class="text-center">
                            <div class="__cate-side-title border-top border-bottom">
                                <span class="widget-title font-semibold">Material</span>
                            </div>
                            <div class="__cate-side-price pb-0">
                                <div class="input-group-overlay input-group-sm">
                                    <input style="{{Session::get('direction') === "rtl" ? 'padding-right: 32px;' : ''}}" placeholder="Search by Material"
                                        class="__inline-38 cz-filter-search form-control form-control-sm appended-form-control"
                                        type="text" id="search-material">
                                    <div class="input-group-append-overlay">
                                        <span class="input-group-text">
                                            <i class="czi-search"></i>
                                        </span>
                           ...
                           <ul id="listmaterial" class="__brands-cate-wrap" data-simplebar data-simplebar-auto-hide="false">
                                @foreach(\App\CPU\BrandManager::get_products_materials() as $material)
                                    <div class="brand mt-2 for-brand-hover {{ Session::get('direction') === "rtl" ? 'mr-2' : '' }}" id="brand">
                                        <li class="flex-between __inline-39"
                                            onclick="location.href='{{ route('products', ['material' => $material, 'data_from' => 'material', 'page' => 1]) }}'">
                                            <div>
                                                {{ $material }}
                                            </div>
                                            <!-- If you want to show some badge based on material count, you can do so here -->
                                        </li>
                                    </div>
                                @endforeach
                            </ul>
